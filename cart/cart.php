                ...
                <?php foreach ($cartItems as $item): ?>
                    <div class="container-product-card">
                        ...
                        <div class="product-photo">
                            <?php
                            $firstImage = explode(',', $item['productPicture'])[0];
                            ?>
                            <img src="/images/<?= htmlspecialchars(trim($firstImage)) ?>" alt="" width="200px" height="200px">
                        ...
                        <div class="product-detail">
                            ...
                            <div class="product-quantity">
                                <form method="post" action="/cartItem/updateQuantity.php">
                                    Quantity: <input type="number" name="newQuantity" value="<?= $item['cartQuantity'] ?>"
                                        min="1">
